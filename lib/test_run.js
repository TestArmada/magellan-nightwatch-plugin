...
NightwatchTestrun.prototype._createTemporaryConfigFile = function () {
  ...
  if (this.sauceBrowserSettings) {
    ...
    nightwatchConfigOptions.localSeleniumVersion = this.SeleniumVersion
    nightwatchConfigOptions.chromedriverVersion = this.chromedriverVersion;
    nightwatchConfigOptions.phantomjsVersion = this.phantomjsVersion;
  }
