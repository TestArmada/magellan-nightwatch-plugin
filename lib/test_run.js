...
NightwatchTestrun.prototype._createTemporaryConfigFile = function () {
  ...
  if (this.sauceBrowserSettings) {
    ...
    nightwatchConfigOptions.localSeleniumVersion = this.seleniumServerVersion;
    nightwatchConfigOptions.isChromedriverPresent = this.isChromedriverPresent;
    nightwatchConfigOptions.isPhantomjsPresent = this.isPhantomjsPresent;
  }
